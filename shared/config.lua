...
-- Checks compatibility with various VMS scripts
Config.vms_barber = GetResourceState('vms_barber') ~= 'missing'
Config.vms_tattooshop = GetResourceState('vms_tattooshop') ~= 'missing'
Config.vms_charcreator = GetResourceState('vms_charcreator') ~= 'missing'
Config.vms_clothestore = GetResourceState('vms_clothestore') ~= 'missing'
...
if not Config.vms_clothestore then
    Config.Stores[#Config.Stores + 1] = {
        type = "clothing",
...
if not Config.vms_tattooshop then
    Config.Stores[#Config.Stores + 1] = {
        type = "tattoo",
